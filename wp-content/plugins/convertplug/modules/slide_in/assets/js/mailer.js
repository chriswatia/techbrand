			...
			jQuery.ajax({
				...
				success: function(result){
					...
					if( detailed_msg !== '' && detailed_msg !== null ) {
						...
						detailed_msg += "<div class='cp-admin-error-notice'>Read How to Fix This, click <a rel='noopener' target='_blank' href='https://www.convertplug.com/plus/docs/something-went-wrong/'>here</a></div>";
					...
					if(typeof obj.action !== 'undefined' && obj.action != null){
						...
						if( cls === 'success' ) {
							...
							if( dont_close && !(slidein.hasClass('cp-do-not-close-inline')) ){
								setTimeout(function(){
									slidein.addClass('cp-hide-inline-style');
						           jQuery(document).trigger('closeSlideIn',[slidein]);
